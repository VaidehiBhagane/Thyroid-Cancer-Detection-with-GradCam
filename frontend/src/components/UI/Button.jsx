...
export default function Button({ 
  ...
  const variants = {
    primary: 'bg-medical-blue hover:bg-blue-700 text-white focus:ring-blue-500',
    ...
    success: 'bg-medical-green hover:bg-green-600 text-white focus:ring-green-500',
    danger: 'bg-medical-red hover:bg-red-600 text-white focus:ring-red-500',
    outline: 'border-2 border-medical-blue text-medical-blue hover:bg-blue-50 dark:hover:bg-blue-900/20 focus:ring-blue-500'
  };
